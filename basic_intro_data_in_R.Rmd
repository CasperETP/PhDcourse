...
It seems simple when set up like this, but when you are coding and you need to find and error this figure is
...
The final example of a conditional is %in% which is not listed in the figure above but still very useful. This weirdly looking %in% is describing a function (which we will get back to and use later) which can search for overlaps e.g. in R:
...
![](https://www.rd.com/wp-content/uploads/2020/02/traffic-light-colors-GettyImages-689407322-MLedit.jpg?resize=700%2C467)
